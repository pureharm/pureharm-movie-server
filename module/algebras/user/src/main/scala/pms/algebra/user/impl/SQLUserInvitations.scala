...
object UserInvitationSQL {
  ...
  private val enum_role:                  Codec[UserRole]             = UserCodecs.enum_user_role
...
final case class UserInvitationSQL[F[_]](private val session: Session[F])(implicit F: MonadCancelThrow[F]) {
  import UserInvitationSQL._
  import pms.db.codecs._
  /*_*/
